...
This file is the quick-reference operating contract for anyhow-kotlin. The longer
...
anyhow-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`anyhow`](https://crates.io/crates/anyhow). Upstream Rust is the behavioral oracle while the
