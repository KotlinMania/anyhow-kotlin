...
kotlin {
    ...
    val xcf = XCFramework("Anyhow")

    macosArm64 {
        binaries.framework { baseName = "Anyhow"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "Anyhow"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "Anyhow"
        flattenPackage = "io.github.kotlinmania.anyhow"
    }

    android {
        namespace = "io.github.kotlinmania.anyhow"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "anyhow-kotlin", version.toString())

    pom {
        name.set("anyhow-kotlin")
        description.set("Kotlin Multiplatform port of dtolnay/anyhow - Flexible concrete Error type built on std::error::Error")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/anyhow-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/anyhow-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/anyhow-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/anyhow-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.anyhow.codeql
