...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Anyhow.swiftmodule/`
...
//      `import Anyhow` above would fail at compile time.
//
//   2. The static archive `libAnyhow.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Anyhow" }` and
//      `flattenPackage = "io.github.kotlinmania.anyhow"` configuration in
...
final class AnyhowExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Anyhow swift module imported cleanly")
    }
}
